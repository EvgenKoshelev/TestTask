...
namespace TestTask.Controllers
{
	...
	public class StoreController : Controller
	{
		...
		public ActionResult Create([Bind(Include = "Id,Name,Address,OperationMode")] Store store)
		{
		...
		[HttpPost]
		[ValidateAntiForgeryToken]
		public ActionResult Edit([Bind(Include = "Id,Name,Address,OperationMode")] Store store, int[] selectedProducts)
		{
			if (ModelState.IsValid)
			{
